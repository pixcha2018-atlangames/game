    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_8578 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_2106,lerp(node_2106,float3(node_8578,node_8578,node_8578),_MaskReflection_var.r),_ReflectionIntensity),node_2106,_UseFReflection),dot(lerp(lerp(node_2106,lerp(node_2106,float3(node_8578,node_8578,node_8578),_MaskReflection_var.r),_ReflectionIntensity),node_2106,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
