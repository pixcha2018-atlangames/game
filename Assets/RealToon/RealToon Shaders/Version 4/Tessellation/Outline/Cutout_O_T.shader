    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_9019 = _Time;
                float node_5371_ang = node_9019.g;
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_7361,lerp(node_7361,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_7361,_UseFReflection),dot(lerp(lerp(node_7361,lerp(node_7361,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_7361,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(lerp(lerp(node_7361,lerp(node_7361,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_7361,_UseFReflection),dot(lerp(lerp(node_7361,lerp(node_7361,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_7361,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
