...
Shader "RealToon/Version 4/Tessellation/No Outline/Cutout" {
    Properties {
        ...
        [Space(8)][MaterialToggle] _TexturePatternStyle ("Texture Pattern Style", Float ) = 0
        ...
        [Space(8)][MaterialToggle] _UseSecondaryCutoutOnly ("Use Secondary Cutout Only", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform fixed _UseSecondaryCutoutOnly;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(lerp( (lerp((_SecondaryCutout_var.r*_Texture_var.r),_SecondaryCutout_var.r,_UseSecondaryCutoutOnly)+lerp(0.5,(-1.0),_Cutout)), saturate(( (1.0 - _Cutout) > 0.5 ? (1.0-(1.0-2.0*((1.0 - _Cutout)-0.5))*(1.0-lerp((_Texture_var.a*_SecondaryCutout_var.r),_SecondaryCutout_var.a,_UseSecondaryCutoutOnly))) : (2.0*(1.0 - _Cutout)*lerp((_Texture_var.a*_SecondaryCutout_var.r),_SecondaryCutout_var.a,_UseSecondaryCutoutOnly)) )), _AlphaBaseCutout ) - 0.5);
                ...
                float node_8846 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_2481,lerp(node_2481,float3(node_8846,node_8846,node_8846),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),dot(lerp(lerp(node_2481,lerp(node_2481,float3(node_8846,node_8846,node_8846),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_8846 = 0.0;
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(lerp(lerp(node_2481,lerp(node_2481,float3(node_8846,node_8846,node_8846),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),dot(lerp(lerp(node_2481,lerp(node_2481,float3(node_8846,node_8846,node_8846),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
