...
Shader "RealToon/Version 4/Tessellation/No Outline/Refraction" {
    Properties {
        ...
        [Space(10)][Header(xxxxxxxxxxxxxxxx)][Header((Refraction))]_RefractionIntensity ("Refraction Intensity", Range(0, 1)) = 0.1

        [Space(10)][Header(xxxxxxxxxxxxxxxx)][Header((Texture Color))]_VertexColorsIntensity ("Vertex Colors Intensity", Range(0, 1)) = 0

        [Space(8)]_MainColor ("Main Color", Color) = (0.7843137,0.7843137,0.7843137,1)
        [MaterialToggle] _MainColorAffectTexture ("Main Color Affect Texture", Float ) = 0

        [Space(8)]_TextureIntensity ("Texture Intensity", Range(0, 1)) = 0
        ...
        [Space(10)][Header(xxxxxxxxxxxxxxxx)][Header((Depth))]_DepthIntensity ("Intensity", Range(0, 1)) = 0
        _DepthColor ("Color", Color) = (1,1,1,1)
        _DepthColorIntensity ("Color Intensity", Float ) = 1.8
        _Depth ("Depth", Float ) = 0.2
        _DepthHardness ("Hardness", Range(0, 1)) = 0.1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _DepthEdgeHardness;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_5260 = lerp(node_3255,lerp(node_3255,lerp( _Texture_var.rgb, (_MainColor.rgb*_Texture_var.rgb), _MainColorAffectTexture ),_Texture_var.a),_TextureIntensity);
                ...
                float node_1226 = 0.0;
                float node_799 = 1.0;
                float3 node_7256 = ((((node_8500*lerp(node_7397,(node_7397*i.vertexColor.rgb),_VertexColorsIntensity))*node_6482)+(lerp(float3(node_7581,node_7581,node_7581),lerp(float3(node_3179,node_3179,node_3179),(node_3179*_GlossColor.rgb),2.22),_MaskGloss_var.rgb)*lerp((node_8388_if_leA*node_2583)+(node_8388_if_leB*_GlossIntensity),_GlossIntensity,node_8388_if_leA*node_8388_if_leB))+lerp(float3(node_3815,node_3815,node_3815),lerp( node_3815, node_137, _FresnelOnLight ),node_2697)+lerp(float3(node_9645,node_9645,node_9645),lerp((_DepthColor.rgb*_DepthColorIntensity),float3(node_1226,node_1226,node_1226),smoothstep( clamp(_DepthEdgeHardness,_DepthEdgeHardness,(node_799-0.001)), node_799, saturate((sceneZ-partZ)/_Depth) )),_DepthIntensity))*_LightColor0.rgb*lerp(1.0,0.3,_DirectionalLightAffectShadow));
                float node_1002 = 0.0;
                ...
                float node_2058 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_714,lerp(node_714,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_714,_UseFReflection),dot(lerp(lerp(node_714,lerp(node_714,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_714,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(lerp(lerp(node_714,lerp(node_714,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_714,_UseFReflection),dot(lerp(lerp(node_714,lerp(node_714,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_714,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
