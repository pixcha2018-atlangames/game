    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_5260 = lerp(node_3255,lerp(node_3255,lerp( _Texture_var.rgb, (_Texture_var.rgb*_MainColor.rgb), _MainColorAffectTexture ),_Texture_var.a),_TextureIntensity);
