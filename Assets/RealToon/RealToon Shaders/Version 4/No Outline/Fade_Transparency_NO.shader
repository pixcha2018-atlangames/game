    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_7987 = lerp((_Texture_var.a*_MaskTransperancy_var.r),_Texture_var.a,_Opacity);
                clip(saturate(( lerp( 1.0, 0.74, _AffectShadow ) > 0.5 ? (1.0-(1.0-2.0*(lerp( 1.0, 0.74, _AffectShadow )-0.5))*(1.0-node_7987)) : (2.0*lerp( 1.0, 0.74, _AffectShadow )*node_7987) )) - 0.5);
                ...
                float node_2058 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_8605,lerp(node_8605,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_8605,_UseFReflection),dot(lerp(lerp(node_8605,lerp(node_8605,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_8605,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
                fixed4 finalRGBA = fixed4(finalColor,node_7987);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(lerp(lerp(node_8605,lerp(node_8605,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_8605,_UseFReflection),dot(lerp(lerp(node_8605,lerp(node_8605,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_8605,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
                fixed4 finalRGBA = fixed4(finalColor * node_7987,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
