    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_6414 = lerp(node_5080,node_8500,_LightIntensityAffectOCALCTPTDirectionalLight);
                ...
                float3 node_4224 = (lerp(lerp(node_6414,lerp(lerp(node_4607,node_5080,(1.0 - _EnableLightFalloff_var)),node_5080,(1.0 - (node_6482*node_1068))),saturate((node_8988.b+node_8988.b+0.05))),node_6414,IFs( 0.0 , 1.0 ))*(lerp(_UseGILighting_var,(_UseGILighting_var+_LightColor0.rgb),_DirectionalLightAffectShadow)+lerp( 0.0, lerp(node_137,float3(node_8889,node_8889,node_8889),node_2697), _FresnelOnShadowDark )));
                ...
                float node_2058 = 0.0;
                float3 finalColor = emissive + lerp(lerp(lerp(node_2481,lerp(node_2481,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),dot(lerp(lerp(node_2481,lerp(node_2481,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_2058 = 0.0;
                float node_3161 = (1.0 - _Saturation);
                float3 finalColor = lerp(lerp(lerp(node_2481,lerp(node_2481,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),dot(lerp(lerp(node_2481,lerp(node_2481,float3(node_2058,node_2058,node_2058),_MaskReflection_var.r),_ReflectionIntensity),node_2481,_UseFReflection),float3(0.3,0.59,0.11)),node_3161);
